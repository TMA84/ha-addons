...
See [repository readme](https://github.com/TMA84/ha-addons#how-to-install) on how to install ebusd addon in supervisor.

See [docs](https://github.com/TMA84/ha-addons/blob/main/ebusd/DOCS.md#how-to-run-ebusd) on how to run ebusd in supervisor.
...
- use [Issues](https://github.com/TMA84/ha-addons/issues) and [pull requests](https://github.com/TMA84/ha-addons/pulls) in the Github repository
